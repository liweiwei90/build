...
sudo apt-get install -y --no-install-recommends \
	...
	device-tree-compiler dosfstools e2fsprogs fakeroot file flex \
	g++-aarch64-linux-gnu gcc-aarch64-linux-gnu gawk genimage git \
	libgnutls28-dev libssl-dev lz4 make mtools patch perl python3 \
	python3-cryptography python3-dev python3-jinja2 python3-pyelftools \
	python3-setuptools rsync socat swig u-boot-tools unzip wget xz-utils zstd
